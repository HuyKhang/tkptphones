...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 09, 2019 lúc 06:16 PM
...
INSERT INTO `produce` (`id`, `id_type`, `id_manu`, `name`, `vat`, `description`, `price`, `promotion_price`, `new`, `image`, `created_at`, `update_at`) VALUES
...
(6, 1, 2, 'Samsung Galaxy A50 64GB', 10, NULL, 6990000, 0, 1, '6.jpg', '2019-03-19 17:00:51', '2019-03-19 17:31:50'),
(7, 5, 1, ' iPad Wifi 128 GB ', 10, 'iPad 6th Wifi 128 GB là chiếc iPad mới được Apple ra mắt với mức giá phải chăng hơn hứa hẹn sẽ mang các thiết bị iPad đến được với đông đảo người dùng hơn.', 11490000, 9900000, 0, '7.png', '2019-03-19 17:02:51', '2019-03-19 17:31:45'),
(8, 3, 3, 'Huawei MediaPad T3 8.0 (2017)', 10, 'Huawei MediaPad T3 8.0 là một chiếc máy tính bảng giá rẻ đến từ Huawei sở hữu rất nhiều ưu điểm đáng giá, nổi trội nhất là cấu hình rất tốt trong phân khúc.', 3990000, 3190000, 0, '8.png', '2019-03-19 17:17:00', '2019-03-19 17:33:12'),
...
(22, 4, 13, 'USB 3.0 16GB Apacer AH354', 10, 'Bảo vệ được đầu USB bằng cách kéo vào trong thân USB.\r\nUSB 3.0 cho tốc độ chép dữ liệu nhanh gấp đôi 2.0.\r\nTốc độ ghi lớn 25 MB/s.\r\nGiúp chép 1 video nặng 1 GB vào USB mất 60 giây.\r\nLưu trữ hơn 15.500 tấm ảnh (1 tấm ~1.5 MB).', 200000, 140000, 1, '22.jpg', '2019-03-20 18:28:16', '2019-03-20 18:28:16'),
(23, 4, 14, 'Chuột không dây Anitech MW315', 10, 'Thương hiệu uy tín đến từ đất nước Thái Lan.\r\nKiểu dáng đẹp mắt với vỏ ngoài màu bạc.\r\nChuột tự động tắt khi không sử dụng trong 5 phút, chạm bất kỳ phím nào để dùng trở lại.\r\nThời gian sử dụng pin có thể lên đến 6 tháng.\r\nSử dụng được cho hệ điều hành Windows và MacOS.', 200000, 150000, 1, '23.jpg', '2019-03-20 18:28:56', '2019-03-20 18:28:56'),
(24, 5, 1, 'iPad Pro 11', 10, 'Máy tính bảng iPad Pro 11 inch 64GB Wifi (2018) được ra mắt vào cuối năm 2018, thu hút nhân viên văn phòng, doanh nhân bởi thiết kế hiện đại, đầy sức đột phá và một cấu hình mạnh mẽ đáp ứng tốt tất cả các nhu cầu từ giải trí đến làm việc.', 21990000, 20990000, 1, '24.png', '2019-03-20 18:33:38', '2019-03-20 18:33:38');
